...
namespace ProjectManagmentSystem.Facade
{
    ...
    public class AnonymousUserFacade : FacadeBase, IAnonymousUserFacade
    {
        ...
        public IList<FlightCard> GetFutureFlightsCards ()
        {
            return _flightDAO.GetFutureFlightsForCards();
        }
        ...
        public Customer RegisterCustomer (Customer customer)
        {
            ...
            {
                throw new RegisterNotCompletedException($"check the details {customer}");
            }
            return customer;
        }

        public void RegisterRequestAirlineToRabbit (AirlineCompany airline)
        {
            try
            {
                RegistrationAirlineRabbit.SendToRabbitAirline(airline);
            }
            catch (Exception e)
            {
                throw new RegisterNotCompletedException($"check the details {airline}");
            }
